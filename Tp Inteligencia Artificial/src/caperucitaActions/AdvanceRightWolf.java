...
public class AdvanceRightWolf extends SearchAction {
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
		 ...
		 * 4, entonces como en este caso la accion es moverse para derecha, tenemos
		 * definido que es Posicion[3], ya que cada sucesor es un array con los
		 * sucesores siguientes conformado.
		 * 
		 * if (posicion[3] != null && posicion[3] ==
