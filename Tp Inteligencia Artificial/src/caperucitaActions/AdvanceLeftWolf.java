...
public class AdvanceLeftWolf extends SearchAction {
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
		 ...
		 * 4, entonces como en este caso la accion es moverse para izquierda, tenemos
		 * definido que es Posicion[4], ya que cada sucesor es un array con los
		 * sucesores siguientes conformado.
		 * 
		 * if (posicion[4] != null && posicion[4] ==
