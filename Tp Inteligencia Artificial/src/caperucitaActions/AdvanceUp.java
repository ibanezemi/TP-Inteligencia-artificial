...
public class AdvanceUp extends SearchAction {
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
		 ...
		 * 
		 * if (caperucitaState.getPosition(posicion+SIGUP) == CaperucitaPerception.EMPTY_PERCEOTION)
		 * 		{
		 * 			caperucitaState.setPosition(posicion+SIGUP);
