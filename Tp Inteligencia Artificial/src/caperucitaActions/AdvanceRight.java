...
public class AdvanceRight extends SearchAction {
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
		 ...
		 * 
		 	* if (caperucitaState.getPosition(posicion+SIGRIGH) == CaperucitaPerception.EMPTY_PERCEOTION)
		 	* 		{
		 	* 			caperucitaState.setPosition(posicion+SIGRIGH);
